...
반복문자지우기 반복문자지우기 리스트 리스트 4866괄호검사  ( [반복문자지우기,반복문자지우기] 부터 [리스트,리스트] 까지 color 4866괄호검사 (빨강) 으로 칠한다 )

파스칼의삼각형 파스칼의삼각형 6 6 반복문자지우기 ( [파스칼의삼각형,파스칼의삼각형] 부터 [6,6] 까지 color 반복문자지우기 (파랑) 으로 칠한다 )
"""
